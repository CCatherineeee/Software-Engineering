      ...
      <el-card style="box-shadow: 7px 7px 7px rgba(0, 0, 0, 0.15)">
        ...
        >
          ...
          <el-form-item label="学号" prop="sid">
            <el-input type="number" v-model="userAccount.sid"></el-input>
          </el-form-item>

          <el-form-item label="密码" prop="password">
            <el-input type="password" v-model="userAccount.password"></el-input>
          </el-form-item>

          <el-form-item label="学院" prop="college">
            <el-select
              v-model="userAccount.college"
              style="width: 100%"
              placeholder="请选择学院"
            >
              <el-option
          ...
          <el-form-item label="手机" prop="phone">
            <el-input type="number" v-model="userAccount.phone"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    save() {},
    back() {
      this.$router.push("/home/student/account");
    },
  },
};
</script>
